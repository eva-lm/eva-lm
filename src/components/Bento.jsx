      ...
      <ul class="row">
        ...
        <div className="p-4">
          ...
          <div>
            ...
            <h1 className="fs-title text-text text-center text-md-end font-mono mt-5">UX/UI Digital Product Designer</h1>
         ...
         <p className="fs-5 mt-3 lh-base text-gray text-center text-md-end">
              Hola! Soy Eva, <b>diseñadora</b> de producto digital y desarrolladora <b>front-end</b>
            </p>
          </div>
          </div>
        </div>
                 ...
                 <Col sm={6} md={8}>
                 <Row class="p-0 m-0">
<Col sm={12} className="bg-primary">
<p>Portfolio</p></Col>
